...
<xml xmlns="http://www.w3.org/1999/xhtml">
  <block type="LLL_comment" id="31" x="58" y="176">
    <field name="NOTE">This is NameCoin, written for Ethereum</field>
    <next>
...
<xml xmlns="http://www.w3.org/1999/xhtml">
  <block type="LLL_comment" id="31" x="49" y="57">
    <field name="NOTE">"I WANT HALF!" Marriage Contract [based on the original work by @mids106]</field>
    <next>
      <block type="LLL_when" id="32" inline="false">
        ...
        <statement name="THEN">
          <block type="LLL_comment" id="38">
            <field name="NOTE">The contract must receive at least 100xbasefee for execution or it stops</field>
            <next>
              <block type="LLL_stop" id="39"></block>
            </next>
          </block>
              ...
              <block type="LLL_when" id="57" inline="false">
                ...
                <statement name="THEN">
                  <block type="LLL_comment" id="62">
                    <field name="NOTE"> Parther_2 can accept the proposal by sending in a transaction with partner_1 given as the first data item</field>
                    <next>
                      ...
                      <block type="LLL_comment" id="90">
                        ...
                        <next>
                          <block type="LLL_comment" id="99">
                            <field name="NOTE">A valid withdrawal instruction is a transaction where: </field>
                            <next>
                                  ...
                                  <block type="LLL_when" id="98" inline="false">
                                    ...
                                    <next>
                                      <block type="LLL_comment" id="107">
                                        <field name="NOTE">Once married, the partners must both agree in order to get divorced. (if only)</field>
                                        <next>
                                          <block type="LLL_when" id="106" inline="false">
                                            <field name="WORD">when</field>
                                            <value name="COND">
