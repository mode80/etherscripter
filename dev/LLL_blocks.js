...
Blockly.Blocks['LLL_init'] = {
  init: function() {
    this.setTooltip('Sets up sections of the contract for _init_ code which runs only once upon contract creation, and _body_ code which runs every time the contract is called thereafter. This will always be the outermost block and there can be only one.')
    this.setColour(LOOP_COLOR)
